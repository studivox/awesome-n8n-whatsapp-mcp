...
1. Use GitHub's **[private vulnerability reporting](../../security/advisories/new)** for this repository (Security tab → "Report a vulnerability"), if enabled.
...
3. The pull request or file that introduced it will be reviewed to understand how it bypassed the [sanitization checklist](CONTRIBUTING.md#mandatory-sanitization--no-exceptions), and the contribution guide will be updated if the checklist needs to be stricter.
